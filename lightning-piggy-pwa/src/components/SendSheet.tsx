            ...
            onClick={async () => {
              if (navigator.share) {
                try {
                  ...
                  console.error(
                    'Something went wrong sharing the invoice',
                    error,
                  );
                }
              } else {
