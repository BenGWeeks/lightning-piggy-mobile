...
const TransactionList: FC = () => {
  ...
  if (!walletContext) {
    throw new Error('TransactionList must be used within a WalletProvider');
  }
      ...
      >
        {transactions?.map((transaction, index) => (
          <ListItem
            ...
            style={{
              borderRadius: '12px',
              background: 'var(--bg-background, #FFF)', // 'rgba(255, 255, 255, 0.1)'
          ...
          >
            <ListItemIcon
              style={{
                ...
                width: '24px',
                height: '24px',
                background: 'var(--functional-red, #FF4951)',
              }}
            >
              <svg
            ...
            <ListItemText
              ...
              secondary={
                <span
                  style={{
                    color: 'var(--text-text-header, #7C8B9A)',
                    fontFamily: 'Segoe UI',
                    fontSize: '16px',
                    fontStyle: 'normal',
                    fontWeight: 400,
                  ...
                  style={{
                    color:
                      transaction.amount < 0
                        ? 'var(--functional-green, #18C070)'
                        : 'var(--functional-red, #FF4951)',
                    fontFamily: 'Segoe UI',
                    fontSize: '16px',
                    fontStyle: 'normal',
                    fontWeight: 700,
