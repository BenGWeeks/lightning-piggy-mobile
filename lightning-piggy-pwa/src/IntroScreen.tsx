...
const IntroScreen: React.FC = () => {
    ...
    return (
        <div style={{ backgroundColor: '#EC008C', height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center' }}>
            ...
            <Button variant="contained" onClick={handleLetsGoClick} style={{ backgroundColor: 'white', color: '#EC008C', marginTop: '37px', fontFamily: 'Segoe UI', fontSize: '16px', fontStyle: 'normal', fontWeight: '700', lineHeight: 'normal', borderRadius: '12px', boxShadow: '0px 0px 12px 0px rgba(0, 0, 0, 0.15)', display: 'inline-flex', height: '52px', padding: '10px 20px', justifyContent: 'center', alignItems: 'center', gap: '10px', flexShrink: '0' }}>
                Let's Go
            </Button>
