...
// Previously we rasterised to PNG which scaled poorly at chip size
// (~17 px); the React Native SVG draws path-perfect at whatever
// dimensions the caller supplies. Aspect ratio is 267:344 — pass
// matching width/height to avoid squashing.
interface Props {
  width: number;
  height: number;
}

export const BtcMapLogoSvg: React.FC<Props> = ({ width, height }) => (
  <Svg width={width} height={height} viewBox="0 0 267 344" fill="none">
    <Path
      d="M.192 133.016C.192 49.881 67.81 0 133.21 0c65.399 0 133.016 49.881 133.016 133.016 0 79.81-119.715 201.741-125.257 207.284-2.217 2.217-4.434 3.325-7.759 3.325-3.326 0-5.543-1.108-7.76-3.325C119.907 334.757.192 211.717.192 133.016Z"
      fill="#0B9072"
    />
    <Mask id="a" x="0" y="0" width="267" height="344">
      <Path
        d="M.192 133.016C.192 49.881 67.81 0 133.21 0c65.399 0 133.016 49.881 133.016 133.016 0 79.81-119.715 201.741-125.257 207.284-2.217 2.217-4.434 3.325-7.759 3.325-3.326 0-5.543-1.108-7.76-3.325C119.907 334.757.192 211.717.192 133.016Z"
        fill="#fff"
      />
