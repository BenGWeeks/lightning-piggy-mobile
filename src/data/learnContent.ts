...
export const courses: Course[] = [
  ...
  {
    id: 'intro-to-hodling',
    title: 'Intro to HODLing',
    description: 'Learn the fundamentals of HODLing Bitcoin — stacking sats, diamond hands, and building long-term wealth with the hardest money ever created.',
    ...
    missions: [
      {
        id: 'why-hodl-bitcoin',
        number: 1,
        title: 'Why HODL Bitcoin?',
        description: 'Understand why Bitcoiners HODL — scarcity, long-term value, and why selling too early is the biggest regret in Bitcoin.',
        videoUrl: null,
        learningOutcomes: [
          { text: 'Understand why Bitcoiners HODL rather than trade' },
          { text: 'Know what makes Bitcoin scarce and why there will only ever be 21 million' },
          { text: 'Appreciate how Bitcoin compares to gold and fiat as a store of value' },
        ],
      },
      {
        id: 'stacking-sats',
        number: 2,
        title: 'Stacking Sats',
        description: 'Learn the art of stacking sats — using dollar cost averaging to steadily build your Bitcoin position without trying to time the market.',
        videoUrl: null,
        learningOutcomes: [
          { text: 'Understand what stacking sats and dollar cost averaging (DCA) mean' },
          { text: 'Know why consistent small purchases beat trying to time the market' },
          { text: 'Build a plan for regularly stacking sats into your piggy bank' },
        ],
      },
    ],
  },
